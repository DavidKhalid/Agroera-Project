...
import 'package:agroera_project/controller/controller_seller/controller_productpage_racunhama.dart';
...
class DetailProductPageRacunHama extends StatefulWidget {
  String category;
  //  final List<Map<String, String>> products;

  static const nameRoutes = "DetailProductPageRacunHama";
  DetailProductPageRacunHama({super.key, required this.category});

  @override
  State<DetailProductPageRacunHama> createState() =>
      _DetailProductPageRacunHamaState();
}

class _DetailProductPageRacunHamaState
    extends State<DetailProductPageRacunHama> {
  ProductPageRacunHamaC _productPageRacunHamaC = ProductPageRacunHamaC();
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Object?>>(
          stream: _productPageRacunHamaC.streamProductseller(widget.category),
