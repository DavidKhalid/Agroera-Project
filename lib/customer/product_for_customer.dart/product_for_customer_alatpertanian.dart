...
class ProductForCustomerAlatPertanian extends StatefulWidget {
  static const nameRoutes = "ProductForCustomerAlatPertanian";
  final String category; // add category parameter
  //final List<CategoryProduct> categoryProducts;
  ProductForCustomerAlatPertanian({super.key, required this.category});

  @override
  State<ProductForCustomerAlatPertanian> createState() =>
      _ProductForCustomerAlatPertanianState();
}

class _ProductForCustomerAlatPertanianState
    extends State<ProductForCustomerAlatPertanian> {
