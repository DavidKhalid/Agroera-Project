...
class ProductForCustomerSprayer extends StatefulWidget {
  static const nameRoutes = "ProductForCustomerSprayer";
  final String category; // add category parameter
  //final List<CategoryProduct> categoryProducts;
  ProductForCustomerSprayer({super.key, required this.category});

  @override
  State<ProductForCustomerSprayer> createState() =>
      _ProductForCustomerSprayerState();
}

class _ProductForCustomerSprayerState extends State<ProductForCustomerSprayer> {
